...
export default function TreatmentStepScreen() {
  ...
  const availableTreatments = useMemo(
    () => TREATMENTS.filter((option) => practice.servicesOffered.includes(option.label)),
    [practice.servicesOffered]
  );
  ...
  return (
    <WizardScreen
      ...
      continueDisabled={!wizard.treatment || !practice.servicesOffered.includes(wizard.treatment)}
